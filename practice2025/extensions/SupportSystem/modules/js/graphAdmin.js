...
(function () {
    ...
    function showNodeEditor(nodeIndex) {
        ...
        // Show/hide delete button for new vs existing nodes
        if (nodeIndex === null) {
            $('#support-node-delete').hide();
        } else {
            $('#support-node-delete').show();
        }
    ...
    function saveNode() {
        ...
        // Check for duplicate IDs if creating a new node or changing ID
        ...
        if (editingNodeIndex === null) {
            ...
            nodes[editingNodeIndex] = nodeData;
        }

        isDirty = true;
        hideNodeEditor();
        updateNodesList();
        updateEdgesList(); // Update in case node IDs have changed
    }
    ...
    function showEdgeEditor(edgeIndex) {
        ...
        // Show/hide delete button for new vs existing edges
        if (edgeIndex === null) {
            $('#support-edge-delete').hide();
        } else {
            $('#support-edge-delete').show();
        }
    ...
    function saveEdge() {
        ...
        if (editingEdgeIndex === null) {
            ...
            edges[editingEdgeIndex] = edgeData;
        }
